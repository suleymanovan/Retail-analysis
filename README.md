...
Эта метрика может находиться в диапазоне от 0 до ∞ и безразлична к направлению ошибок. Чем ниже значение, тем лучше. В тестовой выборке RMSE у нас получился меньше, чем в тренировочной и составляет 66200 фунтов.
